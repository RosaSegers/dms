...
namespace Document.Api.Common.Services
{
    public class RabbitMqService : IAsyncDisposable
    {
        ...
        public async Task PublishAsync(string queueName, SagaMessage message)
        {
        ...
        public async Task StartConsumer(string queueName, Func<SagaMessage, Task> onMessageAsync)
        {
