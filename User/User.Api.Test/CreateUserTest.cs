...
namespace User.Api.Test
{
    public class CreateUserTest
    {
        ...
        public CreateUserTest()
        {
            ...
            _handler = new CreateUserQueryHandler(_hashingServiceMock.Object, _dbContextMock.Object);
        }
        ...
        {
            // Arrange
            var query = new CreateUserQuery("testuser", "testuser@example.com", "TestPassword123");
